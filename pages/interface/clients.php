        ...
        <div class="ui fourteen wide column grid" style="margin-left:10px;padding-bottom:100px">
            <div class="ui thirteen wide column grid">
                ...
                ?>
                    ...
                    ?>
                    <div class="ui five wide column card left floated" id="line<?php echo $resultate->idC; ?>" style="margin-left:0px;">
                        <div class="image">
                            <img src="../../images/clients/<?php echo file_exists("../../images/clients/".$resultate->nomC.$resultate->telephone.".jpg")?$resultate->nomC.$resultate->telephone.".jpg":"defaut.png"; ?>">
                        </div>
                        <div class="content">
                            <div class="header"><?php echo $resultate->nomC; ?></div>
                            <div class="meta">
                                <a href="mailto: <?php echo $resultate->email; ?>" class="group"><?php echo $resultate->email; ?></a>
                                <br>
                                <a href="tel: <?php echo $resultate->telephone; ?>" class="group"><?php echo $resultate->telephone; ?></a>
                            </div>
